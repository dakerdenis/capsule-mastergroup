                            ...
                            <form id="regForm" action="{{ route('auth.register.store') }}" method="POST"
                                    ...
                                    <div class="register_user-element">
                                        <div class="file-upload">
                                            ...
                                            <div class="file-dropzone">
                                                ...
                                                <p>Identity card <span class="req">*</span> <small>max 5 mb</small></p>
                                                <p class="file-text">
                                ...
                                <section class="step is-hidden" data-step="2">
                                    ...
                                    <div class="chk" id="agreeBlk" style="--chk-color:#16a34a;">
                                        <input class="chk__input" type="checkbox" name="agree" id="agree"
                                            required>
                                        <label class="chk__label" for="agree">
                                            <span class="chk__box" aria-hidden="true"></span>
                                            <span class="chk__text">
                                                I confirm my consent to the processing of personal data, and that I have
