...
@push('page-styles')
    ...
    <link rel="stylesheet" href="{{ asset('css/auth/company.css') }}?v={{ filemtime(public_path('css/auth/user.css')) }}">
            ...
            <div class="auth__form-container">
                <div class="auth__form__wrapper">
                    ...
                    <div class="register_user-form">
                        <form id="regForm" action="{{ route('auth.register.store') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="client_type" value="company">
                            <!-- или company во второй форме -->
                            <section class="step" data-step="1">
                                {{-- FIX: добавлены name и required на профильное фото, enctype уже есть --}}
                                <!-- FIRST BLOCK -->
                            ...
                            <section class="step is-hidden" data-step="2">
                                ...
                                <div class="register_user-input register_user-input2 register_user-input3"
                                    id="countryBlk">
                                    <div class="field field--cselect" data-cselect>
                                ...
                                <div class="register_user-input register_user-input2" id="pass1Blk">
                                    <div class="form-block form-block--with-eye">
                                        ...
                                        <button type="button" class="input-eye" aria-label="Show password"
                                            aria-pressed="false">
                                ...
                                <div class="register_user-input register_user-input2" id="pass2Blk">
                                    <div class="form-block form-block--with-eye">
                                        <input id="regPassword2" type="password" name="password_confirmation"
                                ...
                                <div class="register_checkbox">
                                    ...
                                    <label for="agree">I confirm my consent to the processing of personal data, and
                                        that I have read and agree to the terms and conditions.</label>
                                </div>
...
<script src="{{ asset('js/register/registeruser.js') }}?v={{ filemtime(public_path('js/register/registeruser.js')) }}">
</script>
@endpush
